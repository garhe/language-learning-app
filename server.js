...
const languageMap = {
  english: { label: "English", locale: "en-US", voice: "en-US-JennyNeural" },
  mandarin: { label: "Chinese (Mandarin)", locale: "zh-CN", voice: "zh-CN-XiaoxiaoNeural" },
  french: { label: "French", locale: "fr-FR", voice: "fr-FR-DeniseNeural" },
  japanese: { label: "Japanese", locale: "ja-JP", voice: "ja-JP-NanamiNeural" },
  spanish: { label: "Spanish", locale: "es-ES", voice: "es-ES-ElviraNeural" }
};
...
app.post("/api/generate-content", async (req, res) => {
  const { language, level, mode } = req.body || {};
